...
const jsFiles = ['app.js', 'words.js', 'grammar.js', 'reading.js', 'quiz.js', 'review.js', 'stats.js', 'annotate.js', 'progress.js'];
let refIds = new Set();
jsFiles.forEach(f => {
...
const scriptOrder = ['data/words.js', 'data/grammar.js', 'data/reading.js', 'data/quiz-grammar.js',
  'js/annotate.js', 'js/progress.js', 'js/words.js', 'js/grammar.js', 'js/reading.js', 'js/quiz.js', 'js/review.js', 'js/stats.js', 'js/app.js'];
...
check(badOrder.length === 0, badOrder.length ? '脚本缺失: ' + badOrder.join(',') : '13 个脚本引用齐全');
